...
public class ImageSearchConsts {
    ...
    static final String PRODUCT_UPDATE =
    ...
    static final String ID_CARD =
            "https://aip.baidubce.com/rest/2.0/ocr/v1/idcard";

    static  final String RECOGNIZE_ANIMAL =
            "https://aip.baidubce.com/rest/2.0/image-classify/v1/animal";

    /*果蔬识别*/
    static  final String RECOGNIZE_FRUIT_VEGETABLE =
